// rx_fifo.sv - RX Data FIFO (16 x 8-bit)
// Push 8-bit received data, pop on APB read
// Synchronous reset
...
module rx_fifo #(
    ...
    // Overflow flag: set when pushing to full FIFO, sticky until read
    assign overflow = full && wr_en;

    // Read output: return next data or 0 if empty
